...
public class addleave extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String u = request.getParameter("leavetype");
            ...
            try
            {
                ...
                PreparedStatement ps = con.prepareStatement("insert into tblleavetype(LeaveType,Description) values(?,?)");
                ps.setString(1, u);
                ps.setString(2, p);
                ...
                if(i>0)
                {
                   response.sendRedirect("addleavetype.jsp");
