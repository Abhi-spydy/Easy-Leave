...
.succWrap{
 ...
 <div class="loader-bg"></div>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="changepassword.jsp">Change Password</a></li>
                   ...
                   <main class="mn-inner">
                       <%
                           String ld = request.getParameter("leaveid");
                           %>
                <div class="row">
                    <div class="col s12">
                    ...
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <form class="col s12" name="chngpwd" method="post" action="leavedet.jsp">
...
<select class="browser-default" name="status" required="">
          ...
          <div class="input-field col s12">
<textarea id="textarea1" name="description" class="materialize-textarea" name="description" placeholder="Description" length="500" maxlength="500" required></textarea>                                            </div>
 <div class="input-field col s12">
...
<div class="input-field col s12">
<button type="submit" name="Update" class="waves-effect waves-light btn indigo m-b-xs">ADD</button>
