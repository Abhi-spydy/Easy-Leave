...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Manage Leavetype</title>
...
.succWrap{
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="changepassword.jsp">Change Password</a></li>
                   ...
                   <div class="footer">
                    <p class="copyright"><a href="index.html">ELMS </a>©</p>
...
try
            {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.EmailId order by lid desc");
                ...
                while(rs.next())
                {
                                  ...
                                  %>                                        <tr>
                                      <td><%=rs.getInt(1)%></td>
                                      <td><a href="checkhistory.jsp?empid=<%= rs.getInt("id")%>"><%= rs.getString("FirstName")+" "+rs.getString("LastName")%></a></td>
                                            <td><%=rs.getString("LeaveType")%></td>
                                            <td><%=rs.getString("PostingDate")%></td>
                                            <td><% int stats = rs.getInt("Status");
                                            if(stats==1){
                                                %>
                                            ...
                                            <td><a href="leave-details.jsp?leaveid=<%=rs.getInt("lid")%>" class="waves-effect waves-light btn blue m-b-xs"  > View Details</a></td>            
