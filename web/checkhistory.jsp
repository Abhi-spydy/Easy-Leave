...
.succWrap{
    ...
    <body>
        ...
        String n=(String)request.getParameter("empid"); 
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="changepassword.jsp">Change Password</a></li>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Employee Leave History</div>
                    </div>
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Previous Leaves</span>
        ...
        try
            {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT * from tblleaves where empid=(SELECT EmailId from tblemployees where id=?)");
                ps.setString(1, n);
